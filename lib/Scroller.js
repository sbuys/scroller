...
(function (root, factory) {
    ...
    module.exports.prototype = {
        ...
        */
        ...
        /**
         * Given coordinates with respect to the viewport (top, left origin).
         */
        getCoordinates : function (pageX, pageY) {
            return {
                left : (left - this.__scrollLeft) / this.__clientWidth,
                top : (top - this.__scrollLeft) / this.__clientHeight
            };
        },
         ...
         * @param originLeft {Number ? null} Stationary point's left coordinate
         * @param originTop {Number ? null} Stationary point's top coordinate
         * @param callback {Function ? null} A callback that gets fired when the zoom is complete.
         */
        zoomTo : function (level, isAnimated, originLeft, originTop, callback) {
            ...
            // * Origin, `O`, remains stationary.
            // * Scroll position, `S`, moves to a new scroll position, `T` in
            //   anticipation of a new zoom level.
            // * Scaling factor, `k`.
            //
            // * S-O \mapsto T-O = (S-O)k. (By virtue of central dilation).
            // * S+\vector{x} = T. (Introducing variable \vector{x} that will
            // update the current scroll position).
            // * S+\vector{x} - O = (S-O)k.
            // * \vector{x} = (S-O)k - (S-O) = (S-O)(k-1).
            var left = this.__scrollLeft + (this.__scrollLeft-originLeft)*(k-1);
            var top = this.__scrollTop + (this.__scrollTop-originTop)*(k-1);
