...
(function (root, factory) {
    ...
    module.exports.prototype = {
        ...
        */
        ...
        /**
         * Get position in content space.
         */
        getCoordinates : function (scrollLeft, scrollTop) {
        ...
        zoomTo : function (level, isAnimated, fixedLeft, fixedTop, callback) {
            ...
            // * Origin, $O$, remains stationary in content space and in the
            // viewport.
            // * Initial scroll position, $S_i$, denotes the position in content
            // space aligned with the top, left corner of the viewport before
            // dilation.
            // * Final scroll position, $S_f$, denotes the position in content
            // space aligned with the top, left corner of the viewport after
            // dilation.
            ...
            // * $S_f = O + (S_i - O) k_i/k_f$.
            //
            // * Fixed point, $\vector{f}$.
            // * $O = S_i + \vector{f}$.
            // * $S_f = S_i + \vector{f} + (S_i - S_i - \vector{f}) k_i/k_f$.
            //  * $S_f = S_i + \vector{f} - \vector{f} k_i/k_f$.
            // * $S_f = S_i + \vector{f} (1 - k_i/k_f)$.  (Needs scaling by k_f).
            //  * $S_f k_f = S_i k_f + \vector{f} (k_f - k_i)$.
            //  * $S_f k_f = (S_i k_i)(k_f/k_i) + (f)(k_f-k_i)$
            var k1 = level / oldLevel;
            var k2 = level - oldLevel;
            var left = k1*this.__scrollLeft + k2*fixedLeft;
            var top = k1*this.__scrollTop + k2*fixedTop;
        ...
        */
        ...
        __computeScrollMax : function (zoomLevel) {
            ...
            this.__maxScrollLeft = Math.max((this.__contentWidth - this.__clientWidth)*zoomLevel, 0);
            this.__maxScrollTop = Math.max((this.__contentHeight - this.__clientHeight)*zoomLevel, 0);
        },
